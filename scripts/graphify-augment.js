...
function main() {
  ...
  const fileNodes = {
    ...
    endSchematic: addContextFileNode('assets/schematics/VulcanPrinterReleaseEND.litematic'),
    overworldSchematic: addContextFileNode('assets/schematics/VulcanPrinterReleaseOW.litematic')
  }
  ...
  addEdge(addedLinks, concepts.artifacts, fileNodes.endSchematic, 'contains', CONTEXT_SOURCE)
  addEdge(addedLinks, concepts.artifacts, fileNodes.overworldSchematic, 'contains', CONTEXT_SOURCE)
  ...
  addEdge(addedLinks, fileNodes.endSchematic, runtimeCode.nervCli, 'supports', 'assets/schematics/VulcanPrinterReleaseEND.litematic')
  addEdge(addedLinks, fileNodes.overworldSchematic, runtimeCode.nervCli, 'supports', 'assets/schematics/VulcanPrinterReleaseOW.litematic')
  addEdge(addedLinks, fileNodes.meteorJar, concepts.artifacts, 'supports', 'assets/MeteorSpatialFileGenerator.jar')
